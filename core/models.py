...
class Car(models.Model):
    ...
    main_photo = models.ImageField(upload_to="media/photo/%Y/%m/%d/", verbose_name="Фото cо стороны")
    inside_photo_one = models.ImageField(upload_to="media/photo/%Y/%m/%d/", verbose_name="Первое фото внутри")
    inside_photo_two = models.ImageField(upload_to="media/photo/%Y/%m/%d/", verbose_name="Второе фото внутри")
